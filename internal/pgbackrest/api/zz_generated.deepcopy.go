...
func (in *BackupStandbyConfiguration) DeepCopyInto(out *BackupStandbyConfiguration) {
	*out = *in
	if in.InjectService != nil {
		in, out := &in.InjectService, &out.InjectService
		*out = new(bool)
		**out = **in
	}
	if in.InjectSAN != nil {
		in, out := &in.InjectSAN, &out.InjectSAN
		*out = new(bool)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackupStandbyConfiguration.
func (in *BackupStandbyConfiguration) DeepCopy() *BackupStandbyConfiguration {
	if in == nil {
		return nil
	}
	out := new(BackupStandbyConfiguration)
	in.DeepCopyInto(out)
	return out
}
